...
import { LogOut, Lock, ChevronDown, ChevronRight, X, CheckCircle, Sparkles, Send, User as UserIcon, Lightbulb, BarChart2, Award, TrendingUp, AlertCircle, Star, Heart, ArrowRight, Check, Trophy, Medal } from 'lucide-react';
